        ...
        {galleryImageArray.slice(0, displayNum).map((image, index) => (
          <div key={index} className='grid justify-center'>
            ...
            >
              <img
                src={image.image}
                className='object-fill w-[100px] h-[150px] md:w-[200px] md:h-[300px]'
                alt='Gallery item'
              />

              <div className='grid md:hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
