...
export const EVENT_MESSAGES = {
  ...
  notFoundBlogArticle: `Failed to find blog article/s`,
  missingBlogData: `Missing title or content for blog article/s`,
  createBlogFail: `Failed to create blog`,
  deleteBlogFail: `Failed to delete blog`,
  // Users
